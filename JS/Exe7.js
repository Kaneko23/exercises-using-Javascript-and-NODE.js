/* 7. Joaozinho quer calcular e mostrar a quantidade de litros de combustível gastos em uma
...
var horas = parseFloat(prompt("quantas horas de viagem >> "));
var velomed = parseFloat(prompt("qual sua velocidade media? >>"));
var distancia = horas * velomed;
var litros = (distancia / 12);

console.log("para  " + distancia + "Km será necessário " + litros.toLocaleString('pt-br').replace(".", ",") + " de gasolina");